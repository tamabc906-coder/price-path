  ...
  function renderSettings() {
    if (D) {
      ...
      $("thresholds").innerHTML = `<div class="l"><span>Chuông điện thoại</span><span class="pill on">vùng giá + cá mập</span></div>
        ...
        <div class="h">Chuông vùng giá: đổi <span class="mono">whale_gap</span>, <span class="mono">alert_digest</span> trong <span class="mono">docs/data/zone/settings.json</span>. Bật lại push sự kiện: thêm mã vào <span class="mono">events_push</span> trong <span class="mono">docs/data/settings.json</span>.</div>`;
